...
*/
__attribute__(( visibility("default") )) extern NSErrorDomain MobileKeysErrorDomain;
__attribute__(( visibility("default") )) extern NSErrorDomain MobileKeysHttpErrorDomain;
